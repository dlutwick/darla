...
export default function CraftsScreen() {
  const [statusMessage, setStatusMessage] = useState('The Travelling Crafting Nana products and sales in one place.');
  ...
  return (
    <AppScreen>
      ...
      <Card>
        <SectionHeader title="Craft products" subtitle="Product unit, cost, selling price, units sold, and profit in one scan." />
